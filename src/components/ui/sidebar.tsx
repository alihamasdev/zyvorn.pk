...
function SidebarProvider({
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies : can't find reason
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies : can't find reason of error
